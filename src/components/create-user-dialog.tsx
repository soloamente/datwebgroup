...
export function CreateUserDialog({
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    switch (name) {
      case "username":
        errorMessage = validateUsername(finalValue);
        break;
      case "email":
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    data.append("nominativo", formData.nominativo);
    data.append("email", formData.email);
    if (formData.codice_fiscale)
      data.append("codice_fiscale", formData.codice_fiscale);
    if (formData.partita_iva) data.append("partita_iva", formData.partita_iva);
